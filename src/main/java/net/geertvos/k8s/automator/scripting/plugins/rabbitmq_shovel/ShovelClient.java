...
public class ShovelClient {
    ...
    public boolean createShovel(String srcQueue, String sourceUsername, String sourcePassword, String sourceHost,
        ...
        try (CloseableHttpClient httpClient = HttpClients.custom()
            ...
            httpPut.setEntity(new StringEntity(bindingJson.toString()));
